...
# ⚠️ DISABLED TO PREVENT DUPLICATE ADMIN INTERFACE
# The active data is in 'core' app, not 'catalog'.
# This file is kept for reference but models are unregistered to avoid confusion.
